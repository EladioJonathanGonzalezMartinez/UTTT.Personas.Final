...
namespace UTTT.Ejemplo.Linq.Data.Entity
{
    ...
    partial void DeleteEstado(Estado instance);
		...
		public DcGeneralDataContext() : 
				base(global::UTTT.Ejemplo.Linq.Data.Properties.Settings.Default.PersonaUTConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnstrCorreoEChanging(string value);
    partial void OnstrCorreoEChanged();
    ...
    partial void OnidCatEstadoCivilChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_strCorreoE", DbType="VarChar(50)")]
		public string strCorreoE
		{
			get
			{
				return this._strCorreoE;
			}
			set
			{
				if ((this._strCorreoE != value))
				{
					this.OnstrCorreoEChanging(value);
					this.SendPropertyChanging();
					this._strCorreoE = value;
					this.SendPropertyChanged("strCorreoE");
					this.OnstrCorreoEChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_strCodigoP", DbType="VarChar(50)")]
    ...
    partial void OnidPersonaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="usuario", Storage="_usuario1", DbType="VarChar(50) NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_passw", DbType="VarChar(50)")]
		public string passw
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Estado_Usuario", Storage="_Estado", ThisKey="idEstado", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnstrDescripcionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Estado_Usuario", Storage="_Usuario", ThisKey="id", OtherKey="idEstado")]
		public EntitySet<Usuario> Usuario
		{
			get
			{
